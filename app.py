...
## 1. 提案先
〇〇自動車販売株式会社
全国に中古車販売店を展開。店舗スタッフの採用・教育に課題を抱えている。

## 2. 現状の課題
・新人スタッフが入社しても、店舗ごとに教育方法がバラバラ
・ベテラン社員が新人教育に時間を取られている
・車両販売の接客ノウハウが属人化している
・マニュアルは紙やPDFで用意されているが、あまり活用されていない
・新人が「何を覚えればいいのか分からない」という状態になりやすい
・店舗数が増えるほど教育品質にばらつきが出ている

## 3. 提案するサービス
「新人スタッフ向け オンボーディング支援サービス」
入社初日から一人で業務を覚えられるように、動画・マニュアル・チェックリストなどをまとめて提供する。

## 4. サービスの特徴
「読む」だけではなく「見て覚える」
文章だけのマニュアルでは分かりにくい業務を、短い動画で分かりやすく説明。
1本3〜5分程度の動画に分け、新人スタッフがスマートフォンからでも確認できるようにする。

## 5. 導入イメージ・流れ
・STEP1: 既存マニュアル・業務内容のヒアリングと整理
・STEP2: 動画・資料の企画および構成案作成
・STEP3: 動画撮影・素材収集・マニュアル制作
・STEP4: オンライン納品と運用開始後の改善サポート

## 6. 導入メリット
【店舗側】
・新人教育にかかる時間を削減し、店舗間の教育品質を統一
・ベテラン社員の教育負担を大幅に軽減
【新人スタッフ】
・自分のペースで繰り返し学習可能
・「何を覚えればいいか」が明確になり早期戦力化

## 7. 料金プラン
・スタータープラン: 初期 30万円〜（基本動画5本＋マニュアル＋チェックリスト）
・スタンダードプラン: 初期 60万円〜（動画10本＋マニュアル＋店舗別コンテンツ）
・運用サポート: 月額 5万円〜（動画追加制作＋マニュアル更新＋改善対応）

## 8. 期待する効果
「新人が入社するたびに先輩社員が一から教える」状態から「基本的なことは動画・マニュアルで学び、先輩は実践指導に集中する」教育体制へシフト。""", height=400)
